...
const SESSION_EXPIRED =
  "Midas session has expired and could not be renewed automatically. Run `npm run login` " +
  "(opens a visible browser) and approve the push notification on your phone. Stop the MCP " +
  "server first — it holds the same browser profile.";
